...
MODULES		= apps/mist-api wish_app_deps wish_app wish_rpc mist deps/mbedtls-2.1.2/library deps/cBSON deps/ed25519/src ed25519/src deps/bson wish_app_port_deps/unix
...
$(TARGET): $(OBJ)
	gcc $(OBJ) $(LDFLAGS) $(LDLIBS) -o mist-api
