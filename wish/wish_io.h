...
void wish_core_register_send(wish_context_t* h, int (*send)(void *,
unsigned char*, int), void* arg);

void wish_core_signal_tcp_event(wish_context_t* h, enum tcp_event);
...
void wish_core_subscribe_services(wish_context_t* ctx);
...
wish_context_t* wish_core_lookup_ctx_by_connection_id(wish_connection_id_t connection_id);
 ...
 */
wish_context_t* wish_core_lookup_ctx_by_luid_ruid_rhid(uint8_t *luid, uint8_t *ruid,
        uint8_t *rhid);
