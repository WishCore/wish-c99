...
static void make_some_calls(mist_api_t* mist_api) {
    bson bs;
    ...
    mist_api_request(mist_api, &bs, list_services_cb);
    bson_destroy(&bs);
    ...
    mist_api_request(mist_api, &bs, load_app_cb);
    bson_destroy(&bs);
    ...
    bson_append_int(&bs, "id", ++id);
    bson_finish(&bs);
    mist_api_request(mist_api, &bs, get_service_id_cb);
    bson_destroy(&bs);
    ...
    wish_api_request(mist_api, &bs, core_list_identities_cb);
    bson_destroy(&bs);
    ...
    mist_api_request(mist_api, &bs, request_mapping_cb);
    bson_destroy(&bs);
}
