...
TARGET         = wish-core-$(shell git describe --abbrev=0 --dirty --always --tags)-arm-linux
...
EXTRA_INCDIR    = deps/libuv/include deps/mbedtls-2.1.2/include deps/wish-rpc-c99/src deps/bson deps/ed25519/src deps/uthash/include
